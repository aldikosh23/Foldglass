...
**Экран следует за крышкой.** Foldglass превращает закрывание MacBook в плавный стеклянный эффект: изображение растягивается к шарниру, размывается от верхнего края и постепенно гаснет. При открытии движение идёт обратно, в том числе на экране блокировки после сна.
